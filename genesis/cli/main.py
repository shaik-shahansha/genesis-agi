...
"""
    ...
    console.print("\n[bold green]✨ Genesis initialized successfully![/bold green]")
    console.print("\n[bold yellow]📚 Documentation:[/bold yellow]")
    console.print("  • Quick Start: docs/QUICK_START.md")
    console.print("  • API Reference: docs/API.md")
    console.print("  • CLI Commands: docs/CLI_COMMANDS.md")
    console.print("  • Advanced Features: docs/ADVANCED.md")
    console.print("  • Deployment: docs/DEPLOYMENT.md")
    console.print("\n[bold yellow]🎯 Next Steps:[/bold yellow]")
    console.print("  1. Edit .env and add your API keys")
    console.print("     [dim]OpenRouter (RECOMMENDED): https://openrouter.ai/keys - Free models![/dim]")
    console.print("     [dim]Groq: https://console.groq.com/keys - Free & fast![/dim]")
    console.print("  2. Run: [cyan]genesis birth <name>[/cyan]")
    console.print("     [dim]Example: genesis birth atlas[/dim]")
    console.print("  3. Run: [cyan]genesis chat <name>[/cyan]")
    console.print("\n[bold yellow]💡 Examples:[/bold yellow]")
    console.print("  • Basic usage: examples/basic_usage.py")
    console.print("  • Advanced: examples/advanced_usage.py")
    console.print("  • Autonomous life: examples/autonomous_life_demo.py\n")
